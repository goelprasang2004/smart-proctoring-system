...
import { Shield, LayoutDashboard, ClipboardList, AlertTriangle, Link2, LogOut, Users } from 'lucide-react';
...
const AdminLayout = ({ children }) => {
    ...
    const navItems = [
        ...
        { path: '/admin/suspicious', icon: AlertTriangle, label: 'Suspicious Attempts' },
        { path: '/admin/blockchain', icon: Link2, label: 'Blockchain Audit' }
    ];
